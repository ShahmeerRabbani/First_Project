...
function Head(){
    ...
    <div className="header">
            ...
            <div className="middle-head">
                <div className="mid-icon1" title="Home">
                ...
                <div className="mid-icon1" title="Watch">
                    <svg height="28" width="28">
                        <path
                ...
                <div className="mid-icon1" title="Marketplace">
                    <svg height="28" width="28">
                        <path
                ...
                <div className="mid-icon1" title="Groups">
                    <svg height="28" width="28">
                        <path
                ...
                <div className="mid-icon1" title="Gaming">
                    <svg height="28" width="28">
                        <path
